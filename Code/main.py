...
if __name__ == "__main__":
    ...
    history = model.fit(train_images, train_labels, batch_size = 32, epochs = 5, verbose = 1, validation_data=(test_images, test_labels), callbacks=[tensorboard])
    print('training done...')

    model.save('18_000.keras')
